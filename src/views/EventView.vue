      ...
      Event: [
        {
          ...
          date: '6/6',
          description:
            'Den 6 juni Lör vi igång med våran firefly festival, med band av olika grupper som kommer spela olika instrument och trummor, ni får tänka att denna text kommer att ändras senare alltså, så chilla lite! ',
        },
        {
          name: 'Ice ventura',
          date: '28/6',
